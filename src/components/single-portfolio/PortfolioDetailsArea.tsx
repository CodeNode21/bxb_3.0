...
export default function PortfolioDetailsArea() {
  return (
    <>
      <div className="bxb-section-pt overflow-hidden">
        <div className="container">
          <div className="bxb-section-title max-width-780" data-aos="fade-left" data-aos-delay="500">
            <h2>Natural language processing models</h2>
          </div>
          <div className="bxb-portfolio-details-top">
            <div className="bxb-portfolio-details-thumb">
              <img src="/assets/images/portfolio/portfolio-main-img.jpg" alt="Portfolio Thumb" />
            </div>
            <div className="bxb-portfolio-details-info">
              <div className="bxb-portfolio-details-item">
                <p>Client:</p>
                <h3>XYZ Company</h3>
              </div>
              <div className="bxb-portfolio-details-item">
      ...
      <div className="bxb-section-pb overflow-hidden">
        <div className="container">
          <div className="bxb-pb-80">
            <div className="row">
              <div className="col-lg-6">
                <div className="bxb-content-thumb pr50" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="row">
            <div className="col-lg-6 order-lg-2">
              <div className="bxb-content-thumb pl50" data-aos="fade-left" data-aos-delay="500">
        ...
        <div className="container">
          <div className="row gx-5">
            ...
            <div className="col-lg-7 d-flex align-items-center">
              <div className="bxb-default-content w-100 light-color pl-30" data-aos="fade-up" data-aos-delay="600">
