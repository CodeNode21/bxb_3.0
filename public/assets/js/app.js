...
(function ($) {
  ...
  /*--------------------------------------------------------------
  [Table of contents]
  bxb HEADER TRIGER JS INIT
  bxb STICKY MENU JS INIT
  bxb PROGRES CIRCLE JS INIT
  bxb BRAND SLIDER JS INIT
  bxb MAGNIFIC PUPOP JS INIT
  bxb COUNTER JS INIT
  bxb TOOGLE PRICING BUTTON JS INIT
  bxb INTEGRATION SLIDER JS INIT
  bxb INTEGRATION SLIDER JS INIT 2
  bxb TESTIMONIAL SLIDER INIT
  bxb PRELOADER INIT
  ...
  bxb HEADER TRIGER JS INIT
  --------------------------------------------------------------*/
  $(".bxb-header-triger").on("click", function (e) {
    $(".bxb-sidemenu-column, .offcanvas-overlay").addClass("active");
    event.preventDefault(e);
  });
  $(".bxb-sidemenu-close, .offcanvas-overlay").on("click", function () {
    $(".bxb-sidemenu-column, .offcanvas-overlay").removeClass("active");
  });
  ...
  bxb BRAND SLIDER JS INIT
  --------------------------------------------------------------*/
  var brand_slider = $(".bxb-brand-slider");
  ...
  var stats = document.querySelectorAll(".bxb-counter-data");
  ...
  bxb INTEGRATION SLIDER JS INIT
  --------------------------------------------------------------*/
  var int_slider = $(".bxb-int-slider-init");
  ...
  bxb INTEGRATION SLIDER JS INIT
  --------------------------------------------------------------*/
  var int_slider = $(".bxb-int-slider-init2");
  if (int_slider.is_exist()) {
    int_slider.slick({
      slidesToShow: 4,
      slidesToScroll: 1,
  ...
  bxb TESTIMONIAL SLIDER INIT
  --------------------------------------------------------------*/
  var T_slider = $(".bxb-t-slider-init");
  if (T_slider.is_exist()) {
    T_slider.slick(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
      ...
      autoplay: false,
      arrows: true
    }, "slidesToScroll", 1), "infinite", true), "speed", 1500), "lazyLoad", "progressive"), "prevArrow", '<button class="slide-arrow bxb-t-slider-next"></button>'), "nextArrow", '<button class="slide-arrow bxb-t-slider-prev"></button>'));
  }
